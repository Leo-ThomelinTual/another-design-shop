    ...
    <>
      <main className={styles.main}>
        <form className={styles.formContainer} action="">
          ...
          <Input className={styles.colspan1} label="Password" type="password" placeholder="Entrez votre mot de passe" />
          <Input className={styles.colspan1} label="Repeat password" type="password" placeholder="Entrez une nouvel fois votre mot de passe" />
